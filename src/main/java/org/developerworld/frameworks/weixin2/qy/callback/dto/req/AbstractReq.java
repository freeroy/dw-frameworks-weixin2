package org.developerworld.frameworks.weixin2.qy.callback.dto.req;
...
public abstract class AbstractReq implements Serializable{
	...
	public AbstractReq() {
		this.msgType = MsgType.valueOfReqClass(this.getClass());
	}
...
//	 }
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractReq other = (AbstractReq) obj;
		if (agentID == null) {
	...
	public String toString() {
		return "AbstractReq [toUserName=" + toUserName + ", fromUserName=" + fromUserName + ", createTime=" + createTime
